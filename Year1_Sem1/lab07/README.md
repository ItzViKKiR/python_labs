...
В 5 лабораторной было требование - только относительные пути. Но так как tmp_path возвращает абсолютный путь, для проведения тестов данная проверка была выключена
![relative](/Year1_Sem1/lab07/images/relative.png)
