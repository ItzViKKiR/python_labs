...
print(
    f'["a","b","a","c","b","a"] Out counter: {count_freq(["a","b","a","c","b","a"])} Out top_n {top_n(count_freq(["a","b","a","c","b","a"]))}'
)
print(
    f'["bb","aa","bb","aa","cc"] Out counter: {count_freq(["bb","aa","bb","aa","cc"])} Out top_n {top_n(count_freq(["bb","aa","bb","aa","cc"]), 2)}'
)
